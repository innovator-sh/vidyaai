...
import { Eye, EyeSlash, ArrowRight, ArrowLeft } from 'phosphor-react';
...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (currentStep === totalSteps) {
      // Final step - create Firebase account and store profile
      setLoading(true);
      try {
        ...
        <div className="auth-form-container">
          ...
          <form onSubmit={handleSubmit} className="auth-form-split">
            ...
            <div className="register-button-group">
              ...
              >
                <span>{loading ? 'Processing...' : (currentStep === totalSteps ? 'Complete' : 'Next')}</span>
