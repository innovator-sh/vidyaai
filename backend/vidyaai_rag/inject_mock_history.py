...
def inject_mock_data():
    ...
    for doubt in past_doubts:
        mem.add_entry(
            f"Student asked: {doubt}. VidyaAI explained the concepts related to metal and non-metal oxides.",
            metadata={"type": "qa_pair", "topic": "chemistry_oxides"}
        )
    
    # Add a weak area tag
    mem.add_entry(
        "Student struggling with understanding acidic and basic nature of oxides.",
