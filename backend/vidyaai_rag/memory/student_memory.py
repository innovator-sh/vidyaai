...
class StudentMemory:
    ...
    def get_history(self, k: int = 50) -> List[Dict[str, Any]]:
        """Return the most recent k history entries for the history page."""
        try:
            ...
            if results and results.get("documents"):
                for i, doc in enumerate(results["documents"]):
                    ...
                    doc_id = results["ids"][i] if results.get("ids") else str(i)
                    entries.append({"id": doc_id, "content": doc, "metadata": meta})
